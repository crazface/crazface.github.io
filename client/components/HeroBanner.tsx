...
export function HeroBanner() {
  ...
  return (
    <div className="relative w-full h-[650px] md:h-[850px] lg:h-[950px] overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-[1214px] h-[415px] bg-gradient-to-t from-background via-background/95 via-background/80 via-background/50 via-background/20 to-transparent pointer-events-none z-30" />
