      ...
      <section className="grid-container pt-24 pb-section">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            {/* Email Card */}
            <div className="glass rounded-lg p-8 text-center animate-slide-up" style={{ animationDelay: "0.1s" }}>
              <div className="w-16 h-16 bg-black rounded-full flex items-center justify-center mx-auto mb-4">
                <Mail className="w-8 h-8 text-white" />
              </div>
              <h3 className="text-2xl font-black text-foreground mb-2">Email</h3>
              <a 
            ...
            {/* Social Links Card */}
            <div className="glass rounded-lg p-8 text-center animate-slide-up" style={{ animationDelay: "0.2s" }}>
              <h3 className="text-2xl font-black text-foreground mb-6">Connect with me</h3>
          ...
          {/* Contact Form */}
          <div className="glass rounded-lg p-8 animate-slide-up" style={{ animationDelay: "0.3s" }}>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full inline-flex items-center justify-center gap-2 bg-black text-white rounded-lg px-8 py-4 text-lg font-black hover:bg-gray-800 transition-all duration-200 focus-visible"
              >
                Send Message
              </button>
            </form>
