        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="animate-slide-up">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
              <Link
                to="/work"
                className="inline-flex items-center justify-center gap-2 bg-primary text-primary-foreground rounded-full px-8 py-4 text-lg font-black hover:bg-primary/90 transition-all duration-300 hover:scale-105 hover:-translate-y-1"
              >
                View My Work
