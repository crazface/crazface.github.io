            ...
            >
              ...
              {project.id === "schtuff-ad-campaign-2022" ? (
                ...
                <div className="flex flex-col md:flex-row items-start justify-center gap-6">
                  <div className="rounded-2xl overflow-hidden border border-white/10 shadow-sm w-full md:w-1/2 max-w-[560px]" style={{ aspectRatio: '3 / 4' }}>
                    <img
                      src={project.gallery && project.gallery[0] ? project.gallery[0] : project.image}
                      alt={`${project.title} gallery`}
                  ...
                  <div className="rounded-2xl overflow-hidden border border-white/10 shadow-sm w-full md:w-1/2 max-w-[360px]" style={{ aspectRatio: '1 / 1' }}>
                    <img
